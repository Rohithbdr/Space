...
let  crew = [
...

    {
      ...
      "bio": "Mark Richard Shuttleworth is the founder and CEO of Canonical, the company behind the Linux-based Ubuntu operating system. Shuttleworth became the first South African to travel to space as a space tourist and indeed the first African from an independent country to travel to space."
    },
...

    {
      ...
      "bio": "Anousheh Ansari is an Iranian American engineer and co-founder of Prodea Systems. Ansari was the fourth self-funded space tourist, the first self-funded woman to fly to the ISS, and the first Iranian in space.Ansari was the first self-funded woman to fly to the International Space Station."
    }
  ];
